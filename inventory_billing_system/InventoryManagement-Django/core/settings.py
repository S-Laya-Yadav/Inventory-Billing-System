...
INSTALLED_APPS = [
    ...
    'django_filters',                            # uses 'django-filter' app - filtering records 

    'widget_tweaks',                            # uses 'django-widget-tweaks' app - customizing form
    'crispy_forms',                             # uses 'django-crispy-forms' app - stying
    'crispy_bootstrap4',                       # uses 'django-crispy-bootstrap4' app 
    'login_required',                           # uses 'django-login-required-middleware' app - middleware for login protection
